/* OBJECTIF DU PROJET : Réalisation en C de l'algorithme PAM (Partitioning Around Medoids) et comparaison des résultats avec l'algorithme K-MEANS. Note : 19/20 

RÉSULTATS : Disponible à la dernière page du PDF
*/
